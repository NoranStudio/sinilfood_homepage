                            ...
                            >
                                <div className="banner-content-wrapper">
                                    <div className="scroll-down-wrapper">
                                        <img src={scrollDown} alt="스크롤다운이미지" className="scroll-down-img" />
                                    </div>
                                    <div className="banner-texts">
                                        ...
                                        <div className="banner-navigation">
                                            <HiOutlineArrowNarrowLeft onClick={() => swiperRef.current?.slidePrev()} />
                                            <b>{currentPage.toString().padStart(2, "0")}</b> <p>03</p>
                                            <HiOutlineArrowNarrowRight onClick={() => swiperRef.current?.slideNext()} />
                                        </div>
                                    </div>
                                </div>
                            </div>
