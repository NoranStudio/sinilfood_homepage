    ...
    return (
        <div className="slogan-section">
            ...
            <p className="slogan-description">
                신일푸드는 고객의 안전과 건강을 지키기 위해, 엄선된 품질과 철저한 관리를 바탕으로 최상의 제품만을 제공합니다.
            </p>
            {!isMobile && (
                <div className="slogan-contents-wrapper">
                    <Swiper spaceBetween={0} slidesPerView={1} loop={true} onSwiper={(swiper) => (swiper1Ref.current = swiper)}>
                        <SwiperSlide>
                            ...
                            <div className="slogan-banner-contents">
                                <div className="textbox">
                                    ...
                                    <p className="slogan-banner-description">
                                        업소 전용 프리미엄 식용유
                                        <br />
                                        고온에서도 안정적인 품질로 튀김의 바삭함과 풍미를 오래 유지합니다
                                    </p>
                                </div>
                            </div>
                        </SwiperSlide>
