...
const historyItems = [
    ...
    {
        title: "2023년",
        items: ["(주) 신일푸드 화성지점 설립 (서울/경기)", "(주) 신일푸드 전용유 개발 - 온리유 (하이브)"],
        img: history2023Img,
    },
    {
        title: "2022년",
    ...
    {
        title: "2019년",
        items: ["(주) 신일푸드 법인 설립", "(주) 신일푸드 사옥 설립", "(주) 오뚜기 업무협약 체결"],
        img: history2019Img,
    },
    {
        title: "2015년 신일유통 전용유 개발",
        items: ["에이스후라잉 (씨제이제일제당/사조대림)", "크리스피후라잉 (씨제이제일제당)"],
        img: history2015Img,
    },
    {
        title: "2013년 신일유통 창립",
        items: ["(주) 씨제이제일제당 업무협약 체결", "(주) 사조대림 업무협약 체결", "(주) 대경오엔티 업무협약 체결"],
        img: history2013Img,
    },
];
