...
function RenewableEnergy() {
  return (
    <div className="business-content-section">
      <div className="renewable-content-wrapper">
        <div className="renewable-content">
          <h3 className="renewable-title">
            (주)신일푸드는 탄소중립 사업을 통한
            <br />
            <span className="highlight-text">ESG 지속 경영</span>을 실현하고
            있습니다.
          </h3>
        </div>
        <div className="biodiesel-section">
          <div className="biodiesel-content">
            ...
            <p className="biodiesel-description">
              바이오디젤은 오일과 메탄올을 촉매로 반응시켜 생산되며, 이 과정에서
              글리세린이 함께 생성됩니다. 바이오디젤은 일반 경유보다 탄소
              배출량이 적고, 오염물질과 유해물질 배출이 적은 청정
              에너지원입니다. 바이오디젤이 탄소 중립이 가능한 이유는 연소
              과정에서 배출된 이산화탄소를 원료 작물이 다시 흡수하기 때문입니다.
            </p>
            <p className="biodiesel-description-bold">
              <span className="extra-bold">
                탄소 중립이란, 이산화탄소를 배출한 만큼 이산화탄소를 흡수하여
                실질적인 순 배출량이 0(zero)가 되는 개념을 탄소 중립이라 합니다.
              </span>
              지구온난화는 주로 온실기체 때문에 발생하는데, 바이오디젤은
              이산화탄소 배출량을 기존 연료 대비 40~60% 줄여줍니다. 또한,
              폐식용유로 만든 지속가능항공연료(SAF)는 일반 항공연료보다
              이산화탄소 배출을 80% 줄입니다. 우리나라에서는 경유에도
              바이오디젤이 혼합되어 있으며, 혼합 비율은 현재 3.5%입니다.
              2030년까지 이 비율을 5%에서 8%로 늘릴 계획입니다.
            </p>
          </div>
        </div>
        <div className="renewable-content">
          <div className="biodiesel-boxes">
            <div className="biodiesel-box first">
              ...
              <p className="box-sub-description">
                오염물질과 유해 물질의
                <br />
                배출량이 매우 낮은
              </p>
          ...
          <p className="renewable-business-description">
            신일푸드는 일반/사업장 폐기물 중간재활용업을 취득하여 폐기 또는
            버려지는 각종의 식물성잔재물, 동물성잔재물, 튀김식품 잔재물, 제과,
            제빵, 제면 부산물에서 바이오 디젤, 단미 사료를 추출, 회수 하는
            사업을 진행하고 있습니다.
            <span className="bold-text">
              신일푸드는 버려지는 자원을 재활용함으로써 환경을 보호하는 친환경
              기업입니다.
            </span>
          </p>
          <div className="renewable-images">
            <div className="renewable-image-container bioDiesel">
              <div className="renewable-image-content">
                <h4 className="renewable-image-title">바이오디젤</h4>
                <p className="renewable-image-description">
                  식물성 기름이나 동물성 지방을 원료로 하여 만든 바이오연료로
                  바이오에탄올과 함께 가장 널리 사용된다. 이때 만든 바이오디젤이
                  바로 지방산 메틸에스테르(FAME)이다.
                </p>
              </div>
            </div>
            <div className="renewable-image-container food">
              <div className="renewable-image-content">
          ...
          <h3 className="renewable-business-title">
            폐식용유 수거를 통한 BD 생산 과정
          </h3>
          <p className="renewable-business-description">
            국내에서 배출되는 폐식용유 수거 및 이를 이용한 바이오디젤 생산은
            완벽한 재생순환 시스템입니다.
          </p>
        ...
        <div className="container-section">
          ...
          <p className="container-description">
            신일푸드는 부산물 보관으로 인한 화재위험을 예방 하고자 자체적으로
            보관용기를 제작하여
            <br /> 비치 후 주기적인 전용 보관용기 교체 및 분기마다 전문
            청소업체를 통한 폐기물 보관장 청소까지 진행하고 있습니다.
          </p>
          ...
          <div className="biodiesel-info">
            <h3 className="biodiesel-info-title">
              바이오디젤(Bio Diesel)이란?
            </h3>
            <p className="biodiesel-info-description">
              동물성 유지(소기름, 돼지기름 등) 및 식물성 유지(폐식용유, 유채유
              등)를 에탄올과 반응시켜 생산한 친환경 수송연료(지방산
              메틸에스테르)입니다.
              <br />
              기존의 경유 차량 엔진의 설비 변경 없이 사용가능하고, 폐식용유
              재활용을 통한 수질 개선 및 대기오염물질 배출이 없는 친환경
              신재생에너지입니다.
            </p>
            ...
            <div className="biodiesel-background">
              ...
              <p className="background-description">
                2002년 월드컵 개최에 따른 대기질 및 환경개선을 위한 정책으로
                시작(산업부, 환경부, 기재부, 국토해양부 등)
                <br />
                2007년 혼합율 0.5%로 시작하여 2010년부터 2.0% 의무혼합 후 2015년
                7월 30일까지 유지(산업부 고시 근거)
                <br />
                2015년 7월 31일부터 수송용 연료 의무혼합제도[RFS(Renewable Fuel
                Standard)] 범령 발효
              </p>
              <p className="rfs-title">
                *RFS(Renewable Fuel Standard) : 신재생연료 의무혼합제도
              </p>
              <p className="rfs-description">
                의무대상자로 하여금 자신이 공급하는 수송 연료의 일정비율을
                신재생 에너지연료로 혼합하여 공급토록 의무화하는 제도이다.
              </p>
              <div className="rfs-graph-section">
                ...
                <p className="rfs-graph-description">
                  바이오디젤 의무혼합자(정유사)를 통해 전국 모든 주유소에서 현재
                  BD5(경유 97% + 바이오디젤 3%)가 유통, 바이오디젤이 혼합되지
                  아니한 경유는 가짜 경유(불법 유통 대상)
                </p>
              </div>
            </div>
          </div>
          <div className="biodiesel-effects">
            ...
            <div className="effects-box">
              ...
              <div className="effects-box-description">
                <ul>
                  <li>
                    토양 및 해상 유출 시 3주 이내 90%이상 생분해 (오염방지)
                  </li>
                  ...
                  <li>
                    폐식용유 재활용 통한 수질 개선
                    <br />
                    [BD원료로 사용되는 폐식용유 재활용은 매년 소양강 댐
                    저수규모(29억톤)의 21개 이상의 수질을 개선 (우리나라 국민의
                    연간 소비 식수량(약 50억톤)의 12배 수준)]
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="effects-box">
              ...
              <p className="effects-box-description">
                <ul>
                  <li>
                    국내 폐자원(폐식용유, 동물성 기름) 재활용 (2019년 기준 약
                    177천톤)
                  </li>
                  <li>
            ...
            <div className="effects-box">
              ...
              <p className="effects-box-description">
                <ul>
                  ...
                  <li>
                    바이오디젤 플랜트 수출 및 해외 팜 오일 농장 개발(인도네시아,
                    10,800ha)
                  </li>
                  <li>
                    신재생에너지 선도국인 유럽, 미국 등지로 수출 (총 수출 물량 :
                    약 632천kℓ, 약 6,951억원 달성)
                  </li>
