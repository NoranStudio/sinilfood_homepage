      ...
      <div className="renewable-content-wrapper">
        ...
        <div className="biodiesel-section">
          <div className="biodiesel-content">
            ...
            <p className="biodiesel-description">
              바이오디젤은 오일과 메탄올을 촉매로 반응시켜 생산되며, 이 과정에서 글리세린이 함께 생성됩니다. 바이오디젤은 일반
              경유보다 탄소 배출량이 적고, 오염물질과 유해물질 배출이 적은 청정 에너지원입니다. 바이오디젤이 탄소 중립이 가능한
              이유는 연소 과정에서 배출된 이산화탄소를 원료 작물이 다시 흡수하기 때문입니다.
            </p>
            <p className="biodiesel-description-bold">
              <span className="extra-bold">
                탄소 중립이란, 이산화탄소를 배출한 만큼 이산화탄소를 흡수하여 실질적인 순 배출량이 0(zero)가 되는 개념을 탄소
                중립이라 합니다.
              </span>{" "}
              지구온난화는 주로 온실기체 때문에 발생하는데, 바이오디젤은 이산화탄소 배출량을 기존 연료 대비 40~60% 줄여줍니다.
              또한, 폐식용유로 만든 지속가능항공연료(SAF)는 일반 항공연료보다 이산화탄소 배출을 80% 줄입니다. 우리나라에서는
              경유에도 바이오디젤이 혼합되어 있으며, 혼합 비율은 현재 3.5%입니다. 2030년까지 이 비율을 5%에서 8%로 늘릴
              계획입니다.
            </p>
          </div>
        </div>
        <div className="renewable-content">
          <div className="biodiesel-boxes">
            <div className="biodiesel-box first">
              ...
              <p className="box-sub-description">오염물질과 유해 물질의 배출량이 매우 낮은</p>
            ...
            <div className="biodiesel-box third">
              ...
              <p className="box-sub-description">우리나라 경유차량 바이오디젤의 혼합 비율</p>
          ...
          <p className="renewable-business-description">
            신일푸드는 일반/사업장 폐기물 중간재활용업을 취득하여 폐기 또는 버려지는 각종의 식물성잔재물, 동물성잔재물, 튀김식품
            잔재물, 제과, 제빵, 제면 부산물에서 바이오 디젤, 단미 사료를 추출, 회수 하는 사업을 진행하고 있습니다.{" "}
            <span className="bold-text">신일푸드는 버려지는 자원을 재활용함으로써 환경을 보호하는 친환경 기업입니다.</span>
          </p>
            ...
            <div className="renewable-image-container bioDiesel">
              <div className="renewable-image-content">
                ...
                <p className="renewable-image-description">
                  식물성 기름이나 동물성 지방을 원료로 하여 만든 바이오연료로 바이오에탄올과 함께 가장 널리 사용된다. 이때 만든
                  바이오디젤이 바로 지방산 메틸에스테르(FAME)이다.
                </p>
              </div>
            </div>
          ...
          <p className="renewable-business-description">식품공장에서 발생하는 부산물을 평균 데이터로 사용 한 통계입니다.</p>
              ...
              <div className="process-box" key={index}>
                ...
                <div className="process-content">
                  ...
                  <div className="process-text-content">
                    {box.title.length === 1 && <h4 className="process-title"> </h4>}
                    <h4 className="process-title">{box.title[0]}</h4>
                    {box.title.length > 1 && <h4 className="process-title">{box.title[1]}</h4>}
        ...
        <div className="container-section">
          ...
          <p className="container-description">
            ...
            <br /> 비치 후 주기적인 전용 보관용기 교체 및 분기마다 전문 청소업체를 통한 폐기물 보관장 청소까지 진행하고 있습니다.
          </p>
          ...
          <div className="biodiesel-info">
            ...
            <p className="biodiesel-info-description">
              ...
              수송연료(지방산 메틸에스테르)입니다.
              <br />
              기존의 경유 차량 엔진의 설비 변경 없이 사용가능하고, 폐식용유 재활용을 통한 수질 개선 및 대기오염물질 배출이 없는
              친환경 신재생에너지입니다.
            </p>
            ...
            <div className="biodiesel-background">
              ...
              <p className="rfs-description">
                의무대상자로 하여금 자신이 공급하는 수송 연료의 일정비율을 신재생 에너지연료로 혼합하여 공급토록 의무화하는
                제도이다.
              </p>
              <div className="rfs-graph-section">
                <h4 className="rfs-graph-title">&lt; RFS 시행령의 바이오디젤 중장기 의무혼합비율(%) &gt;</h4>
                <img src={playGraph} alt="RFS 시행령 그래프" className="rfs-graph" />
                <p className="rfs-graph-description">
                  바이오디젤 의무혼합자(정유사)를 통해 전국 모든 주유소에서 현재 BD5(경유 97% + 바이오디젤 3%)가 유통,
                  바이오디젤이 혼합되지 아니한 경유는 가짜 경유(불법 유통 대상)
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="effects-box-description">
                <ul>
                  ...
                  <li>
                    폐식용유 재활용 통한 수질 개선
                    <br />
                    [BD원료로 사용되는 폐식용유 재활용은 매년 소양강 댐 저수규모(29억톤)의 21개 이상의 수질을 개선 (우리나라
                    국민의 연간 소비 식수량(약 50억톤)의 12배 수준)]
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="effects-box">
              ...
              <p className="effects-box-description">
                <ul>
                  ...
                  <li>신재생에너지 선도국인 유럽, 미국 등지로 수출 (총 수출 물량 : 약 632천kℓ, 약 6,951억원 달성)</li>
