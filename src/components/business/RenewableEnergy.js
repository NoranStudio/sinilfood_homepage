                ...
                <div className="biodiesel-section">
                    <div className="biodiesel-content">
                        ...
                        <p className="biodiesel-description-bold">
                            ...
                            줄입니다. 우리나라에서는 경유에도 바이오디젤이 혼합되어 있으며, 혼합 비율은 현재 3.5%입니다.
                ...
                <div className="container-section">
                    ...
                    <div className="biodiesel-info">
                        ...
                        <p className="biodiesel-info-description">
                            ...
                            수송연료(지방산 메틸에스테르)입니다.
                            <br />
                            기존의 경유 차량 엔진의 설비 변경 없이 사용가능하고, 폐식용유 재활용을 통한 수질 개선 및 대기오염물질
                            배출이 없는 친환경 신재생에너지입니다.
                        </p>
                        ...
                        <div className="biodiesel-background">
                            ...
                            <p className="background-description">
                                ...
                                국토해양부 등)
                                <br />
                                2007년 혼합율 0.5%로 시작하여 2010년부터 2.0% 의무혼합 후 2015년 7월 30일까지 유지(산업부 고시
                                근거)
                                <br />
                            ...
                            <div className="effects-box-description">
                                <ul>
                                    ...
                                    <li>
                                        폐식용유 재활용 통한 수질 개선
                                        <br />
                                        [BD원료로 사용되는 폐식용유 재활용은 매년 소양강 댐 저수규모(29억톤)의 21개 이상의 수질을
                                        개선 (우리나라 국민의 연간 소비 식수량(약 50억톤)의 12배 수준)]
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="effects-box">
                            ...
                            <p className="effects-box-description">
                                <ul>
                                    ...
                                    <li>
                                        신재생에너지 선도국인 유럽, 미국 등지로 수출 (총 수출 물량 : 약 632천kℓ, 약 6,951억원
                                        달성)
                                    </li>
                                    <li>경유 차량의 기존 엔진 그대로 적용 가능</li>
                                    <li>
                                        바이오디젤 보급 이후, 전국의 폐식용유 수거 체계 완벽한 구축 [신산업 및 대규모(전국 약
                                        5,000명) 인력 창출]
                                    </li>
                                </ul>
                            </p>
