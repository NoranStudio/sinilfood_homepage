            ...
            <div className="manufacturing-content-mobile">
                <div className="advantages-boxes-mobile">
                    ...
                    <p className="manufacturing-description-mobile">
                        ...
                        <span className="description-bold-mobile">고객의 필요에 맞게 커스터마이징된 식용유</span>
                        <span className="description-light-mobile">입니다</span>
                    </p>
                </div>
                <div className="feature-section-mobile">
                    ...
                    <p className="feature-description-mobile">
                        전용유의 특징은 기름 산패율 측면에서 식용유보다 훨씬 뛰어나며 용도별 전용 배합제품에 프랜차이즈 전용
                        디자인으로 인한 홍보 효과까지 가능하며 각 브랜드별로 용도별 최적화의 비율을 통한 전용유 제작으로 제품의
                        사용기간을 늘려주고 바삭한 식감 역시 일반유보다 향상되어 맛의 균일화가 가능합니다.
                    </p>
                </div>
                <div className="advantages-boxes-mobile">
                    ...
                    <div className="advantage-box-mobile">
                        ...
                        <p className="advantage-box-description-mobile">가맹점에 대한 지속적인 관리와 안정적인 수익구조 구축</p>
                    </div>
                    <div className="advantage-box-mobile">
                        <h4 className="advantage-box-title-mobile">차별성</h4>
                        <p className="advantage-box-description-mobile">
                            프랜차이즈 가맹점의 차별화된 재고관리와 소비자에게 신뢰를 줄수있는 대기업 제조사와의 전용유 제작으로
                            인해 안정적인 생산과 공급망 구축과 경쟁력 있는 가격 으로 인한 지속가능한 수익구조 완성
                        </p>
                    </div>
                </div>
