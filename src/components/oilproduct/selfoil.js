...
function SelfOil() {
  // 자사 전용유 7개
  const selfOils = [
    { name: '백설 에이스 후라이', image: self1 },
    { name: '해표 에이스 후라이', image: self2 },
    { name: '에이스 프로', image: self3 },
    { name: '크리스피 후라이유', image: self4 },
  ...
  // 일반유 20개
  const generalOils = [
    { name: '큐원 현미유', image: gen1 },
    { name: '백설 현미유', image: gen2 },
    { name: '백설 하이올리유', image: gen3 },
    { name: '백설 슈퍼 후라이', image: gen4 },
    { name: '백설 옥수수유', image: gen5 },
    { name: '백설 카놀라유', image: gen6 },
    { name: '아삭바삭 후라이유', image: gen7 },
    { name: '해표 옥수수유', image: gen8 },
    { name: '해표 카놀라유', image: gen9 },
    { name: '오뚜기 골드 후라이유', image: gen10 },
    ...
    { name: '매직 프라이유', image: gen19 },
    { name: '씨앗이프 공격레지', image: gen20 },
  ];
